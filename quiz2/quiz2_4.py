...
x2_values = (-theta_0 - theta_1 * x1_values + 1) / theta_2  # Calculate x2 by setting g=0
# print(x1_values)
# print(x2_values)
...
# Change predictor (quiz 2)
# predicted label=sign(gθ(x)+1)
def predict_label(x, theta):
    return np.sign(np.dot(x, theta) + 1)
